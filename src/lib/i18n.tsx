...
const translations = {
  ...
  ru: {
    ...
    heroDesc: "ZeroCard превращает USDT в ежедневный платёжный инструмент. Плати по миру без ограничений - 200+ стран, Apple Pay, Google Pay и PayPal. Получай 1% кэшбэк на всё, 5% годовых на остаток и ноль комиссий. Международные платежи, оплата за границей и глобальные переводы в одной карте.",
